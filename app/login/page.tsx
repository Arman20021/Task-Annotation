...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f8fbff] px-4">
      <div className="absolute left-[-120px] top-[-120px] h-80 w-80 rounded-full bg-sky-200/70 blur-3xl" />
      <div className="absolute right-[-100px] top-20 h-96 w-96 rounded-full bg-violet-200/70 blur-3xl" />
      <div className="absolute bottom-[-120px] left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-cyan-100 blur-3xl" />
        ...
        <div className="relative">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-2xl bg-gradient-to-r from-violet-500 to-sky-500 px-4 py-3 font-semibold text-white shadow-[0_18px_35px_rgba(99,102,241,0.28)] transition hover:scale-[1.01] hover:shadow-[0_22px_45px_rgba(99,102,241,0.35)] disabled:cursor-not-allowed disabled:opacity-60"
            >
